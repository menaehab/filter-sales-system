    ...
    <div class="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        ...
        @if($searchable)
            <div class="relative w-full sm:max-w-xs" x-data="{ focused: false }">
                <svg
                    class="pointer-events-none absolute inset-s-3 top-1/2 h-4 w-4 -translate-y-1/2 transition-colors duration-200"
                    :class="focused ? 'text-emerald-500' : 'text-gray-400'"
    ...
    <div class="relative overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm">
        ...
        >
            <div class="flex items-center gap-2.5 rounded-xl bg-white px-4 py-2.5 shadow-lg ring-1 ring-gray-200">
                <svg class="h-4 w-4 animate-spin text-emerald-600" fill="none" viewBox="0 0 24 24" aria-hidden="true">
        ...
        <div class="overflow-x-auto table-card-mobile">
            <table class="min-w-full divide-y divide-gray-100">
                <thead class="sticky top-0 z-10 bg-gray-50/95 backdrop-blur-sm
                              shadow-[0_1px_0_0_theme(colors.gray.200)]">
                    <tr>
                        @foreach($headers as $header)
                            ...
                            >
                                <div class="flex items-center gap-1.5
                                    ...
                                    @if($header['sortable'] ?? false)
                                        <span class="inline-flex flex-col opacity-50 transition-opacity group-hover:opacity-100"
                                              aria-hidden="true">
    ...
    @if($paginated)
        <div class="mt-4 flex flex-col items-center justify-between gap-4 sm:flex-row">
            ...
            <nav class="flex items-center gap-1" aria-label="Pagination">
                ...
                >
                    <svg class="h-4 w-4 rtl:rotate-180" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" aria-hidden="true">
