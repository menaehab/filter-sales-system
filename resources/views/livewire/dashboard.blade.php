    ...
    <div class="mb-8">
        <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
                @php
                    $hour = now()->hour;
                    $greeting = $hour < 12 ? __('keywords.good_morning')
                              : ($hour < 18  ? __('keywords.good_afternoon')
            ...
            <div class="h-full rounded-2xl border border-gray-200 bg-white shadow-sm">
                ...
                <div class="divide-y divide-gray-50">
                    @forelse($this->lowStockProducts as $product)
                        <div class="flex items-center justify-between px-5 py-3 transition-colors duration-150 hover:bg-gray-50/70">
    ...
    function initDashboardCharts() {
        ...
        if (salesCtx) {
            _chartRegistry['sales'] = new Chart(salesCtx, {
                ...
                options: _chartDefaults({ y: { beginAtZero: true } }),
            });
        }
