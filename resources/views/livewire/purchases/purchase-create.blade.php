                        ...
                        @if ($this->selectedSupplier)
                            <div
                                ...
                                <div class="flex items-center justify-between gap-3">
                                    ...
                                    <span class="font-semibold">{{ number_format($this->selectedSupplier->balance, 2) }}
                                ...
                                @if ($this->available_supplier_credit > 0)
                                    <div class="mt-1 flex items-center justify-between gap-3">
                                        ...
                                        <span
                                            class="font-semibold text-emerald-700">{{ number_format($this->available_supplier_credit, 2) }}
                                            {{ __('keywords.currency') }}</span>
                                    </div>
                                @endif
                            </div>
                        ...
                        @if ($this->applied_supplier_credit > 0)
                            <div class="flex justify-between sm:gap-8 text-sm">
                                ...
                                <span class="font-medium text-emerald-600">
                                    - {{ number_format($this->applied_supplier_credit, 2) }}
                                    {{ __('keywords.currency') }}
                                </span>
                            </div>
                        @endif
        ...
        <x-slot:body>
            <div class="space-y-5">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <x-input name="newProduct.cost_price" label="{{ __('keywords.cost_price') }}" placeholder="0.00"
                        type="number" step="0.01" wire:model.blur="newProduct.cost_price" required />

                    <x-input name="newProduct.sell_price" label="{{ __('keywords.sell_price') }}" placeholder="0.00"
                        type="number" step="0.01" wire:model.blur="newProduct.sell_price" required />
