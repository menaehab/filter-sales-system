<div class="max-w-3xl mx-auto p-8 bg-white">
    ...
    <div class="border-2 border-black p-6">
        <div class="text-center mb-6 border-b-2 border-black pb-4">
            ...
            <p class="text-xl font-semibold">{{ __('keywords.payment_voucher') }}</p>
        </div>
        ...
        <div class="grid grid-cols-2 gap-4 mb-6 text-sm">
            ...
            <div>
                ...
                @if ($payment->supplier?->phone_numbers !== [])
                    <p class="mb-2"><strong>{{ __('keywords.phone') }}:</strong>
                        {{ implode(' - ', $payment->supplier->phone_numbers) }}</p>
                @endif
        ...
        <div class="grid grid-cols-2 gap-8 mt-8 pt-6 border-t border-black text-sm">
            <div class="text-center">
                <div class="border-t border-gray-400 pt-2 mt-16">
                    <p class="font-semibold">{{ __('keywords.supplier_signature') }}</p>
                </div>
            </div>
            <div class="text-center">
                <div class="border-t border-gray-400 pt-2 mt-16">
